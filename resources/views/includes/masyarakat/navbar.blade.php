...
<nav class="navbar navbar-expand-lg navbar-dark position-sticky top-0 z-full shadow-sm" style="background-color: #FF7F50;">
    <div class="container">
        <nav class="navbar">
            <div class="container-fluid">
              <a class="navbar-brand fw-bold text-white" href="{{ url('/')}}">
                <img src="/assets/img/logo-1@4x.png" alt="Logo" width="30" class="d-inline-block align-text-top">
                Laporin
              </a>
            </div>
        </nav>
